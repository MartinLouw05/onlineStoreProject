...
<html>
	<head>
		...
		<?php require ('../functions/funcCart.php'); ?>
		<?php require ('../functions/funcProduct.php'); ?>
	</head>
	<body>
		<header>
			<form method='post' class='headerGrid'>
				<div class='title'>
				...
				<div class='titleButtons'>
					...
					<button id='btnSignIn' name='btnSignIn' class='navBtn'>Sign In</button>
